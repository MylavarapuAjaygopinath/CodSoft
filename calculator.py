...
for b in button:
    ...
    if b=='C':
        tk.Button(window,text=b,bg='orange',padx=25, pady=15,bd=10, font=('Oswald',25), command=a).grid(row=row_val, column=col_val)
        col_val += 1
    elif b=='=':
        tk.Button(window,text=b,bg='pink',padx=25, pady=15,bd=10, font=('Oswald',25), command=a).grid(row=row_val, column=col_val)
        col_val += 1
    else:
